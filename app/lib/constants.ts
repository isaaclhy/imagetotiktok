...
export const PROMPTS = [
  ...
  'Girl holding a white pottery plate covering half of the face, on the plate it says "{x}"',
  ...
  'First person POV You\'re watching Netflix in bed on your laptop. And on the screen the word should be "{x}" as part of the movie title',
...
export const FUNNY_QUESTIONS = [
  ...
  'Would you try let another guy sleep with me if it saves your life?',
  ...
  'If I were born as a man with the same personality, would you still love me?',
  ...
  'If I was in your ex\'s body and she\'s in my body, who would you be in love with?',
  'Would you stay with me if I loose both my arms and legs?',
  'Would you rather kiss another woman or die in a plane crash?',
  ...
  'Would you rather I cut all my hair off or never wear makeup again?',
  ...
  'Would you rather forget everything about our past or never be able to imagine a future with you?',
  'Would you spend a year with me for $1 mil?',
  'If we break up, who would hook up first?',
  'If my little sister and I are in a burning building, who would you save first?',
  'If I got really ugly tomorrow, would you still be with me?',
  ...
  'If you need to make out with your best friend or your ex to save my life, who would it be?',
  'If you found a soulmate, would you leave me for them?',
  'If you need to pick one of your friends to *chill out* with me, who would it be?',
  'Which one of my friends do you think is the most good-looking?',
  'Would you rather I hook up with your best friend once or stay loyal but never have sex with you again?',
  'Would you rather wake up tomorrow with zero memory of me or know everything about me but be forced to break up right now?',
  'Would you rather watch me get with your sibling or watch your ex get with me?',
  'Rank my friends from most bangable to least',
  'Would you rather I become "too hot" or stay average?',
  'If I cheated once but confessed immediately, would you forgive me?',
  'Would you rather accidentally sent a naughty pic to my mom or my dad?',
  ...
  'Would you rather cheat or me or never be able to see me again?',
  'On a scale of 1 to 10, how well do you treat me?',
  'If I got arrested, what crime do you think I committed?',
  'If I disappeared for 24 hours, where\'s the first place you\'ll look for me?',
  'When I am mad, which cartoon character do I act like the most?',
  ...
  'Would you rather walk in on your parents doing it or have them walk in when we\'re doing it?',
  'Would you rather send a naughty pic to your family or friends group chat?',
  'Would you rather hook up with you ex or have my ex hook up with me?',
  'Would you rather get $50,000 or spend your birthday with me?',
  'Who do you love more, your mom or me?',
  'Would you rather I text my ex once or you delete your instagram',
  'If my ex offered me $50,000 to meet for dinner, should I go?',
